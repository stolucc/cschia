...
class GrantApplications(db.Model):
    ...
    ethical_q1 = db.Column(db.String)
    ethical_q2 = db.Column(db.String)
...
class Collaborators(db.Model):
    ...
    #events = db.Column(db.Integer, nullable=True)
...
class Report(db.Model):
    id=db.Column(db.Integer,db.ForeignKey("report.id"),primary_key=True,autoincrement=True)
    title=db.Column(db.String(255))
    text=db.Column(db.Text())
    def __repr__(self):
        return "<PersonalReport {}>".format(self.id)
#
